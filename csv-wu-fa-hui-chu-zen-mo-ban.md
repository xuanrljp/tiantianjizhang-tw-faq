...
#### 2.iPhone所設定的預設郵件APP重新是否是Apple自家的【郵件】App

如果您有設定Gmail等其他APP為預設郵件APP， 請把預設郵件APP重新改為【郵件】。

![list](<.gitbook/assets/image (17).png>)

#### **3. 檢查【郵件】APP的「寄件匣」是否有未傳送的電子郵件**
